...
public enum MHExInfoToggle {
    MOON_PHASE(Vanilla.MOON_PHASE, Vanilla.MOON_PHASE_LINE_POSITION),
    WEATHER(Vanilla.WEATHER, Vanilla.WEATHER_LINE_POSITION),
    MEK_RADIATION_EXPOSURE(ModIntegration.MEK_RADIATION_EXPOSURE, ModIntegration.MEK_RADIATION_EXPOSURE_LINE_POSITION),
